...
pub struct LslStreamInfo { pub info: StreamInfo }
pub struct LslOutlet { pub outlet: StreamOutlet }
pub struct LslInlet { pub inlet: StreamInlet }
pub struct LslContinuousResolver { pub resolver: ContinuousResolver }
pub struct LslXmlPtr { pub node: XmlNode }
...
pub extern "C" fn lsl_create_streaminfo(
    name: *const c_char, type_: *const c_char,
    channel_count: i32, nominal_srate: c_double,
    channel_format: i32, source_id: *const c_char,
) -> *mut LslStreamInfo {
    ...
    let info = StreamInfo::new(&name, &type_, channel_count as u32, nominal_srate, fmt, &source_id);
    Box::into_raw(Box::new(LslStreamInfo { info }))
}

#[no_mangle]
pub extern "C" fn lsl_destroy_streaminfo(info: *mut LslStreamInfo) {
    if !info.is_null() { unsafe { let _ = Box::from_raw(info); } }
}
...
pub extern "C" fn lsl_copy_streaminfo(info: *mut LslStreamInfo) -> *mut LslStreamInfo {
    ...
    let new_info = StreamInfo::new(
        &s.name(), &s.type_(), s.channel_count(), s.nominal_srate(),
        s.channel_format(), &s.source_id(),
    );
...
#[no_mangle]
pub extern "C" fn lsl_stream_info_matches_query(info: *mut LslStreamInfo, query: *const c_char) -> i32 {
    if info.is_null() { return 0; }
...
#[no_mangle]
pub extern "C" fn lsl_create_outlet(info: *mut LslStreamInfo, chunk_size: i32, max_buffered: i32) -> *mut LslOutlet {
    null_check!(info);
    let info = unsafe { &*info };
...
#[no_mangle]
pub extern "C" fn lsl_create_outlet_ex(info: *mut LslStreamInfo, chunk_size: i32, max_buffered: i32, _flags: i32) -> *mut LslOutlet {
...
macro_rules! impl_push_sample {
    ($fname:ident, $fnamert:ident, $fnamertp:ident, $ty:ty, $method:ident) => {
        ...
        #[no_mangle]
        pub extern "C" fn $fnamert(out: *mut LslOutlet, data: *const $ty, timestamp: c_double) -> i32 {
            $fnamertp(out, data, timestamp, 1)
        }
        #[no_mangle]
        pub extern "C" fn $fnamertp(out: *mut LslOutlet, data: *const $ty, timestamp: c_double, pushthrough: i32) -> i32 {
            if out.is_null() || data.is_null() { return -3; }
...
impl_push_sample!(lsl_push_sample_f, lsl_push_sample_ft, lsl_push_sample_ftp, c_float, push_sample_f);
impl_push_sample!(lsl_push_sample_d, lsl_push_sample_dt, lsl_push_sample_dtp, c_double, push_sample_d);
impl_push_sample!(lsl_push_sample_i, lsl_push_sample_it, lsl_push_sample_itp, i32, push_sample_i32);
impl_push_sample!(lsl_push_sample_s, lsl_push_sample_st, lsl_push_sample_stp, i16, push_sample_i16);
impl_push_sample!(lsl_push_sample_l, lsl_push_sample_lt, lsl_push_sample_ltp, i64, push_sample_i64);
...
#[no_mangle]
pub extern "C" fn lsl_push_sample_ct(out: *mut LslOutlet, data: *const c_char, timestamp: c_double) -> i32 {
    lsl_push_sample_ctp(out, data, timestamp, 1)
}
#[no_mangle]
pub extern "C" fn lsl_push_sample_ctp(out: *mut LslOutlet, data: *const c_char, timestamp: c_double, pushthrough: i32) -> i32 {
    if out.is_null() || data.is_null() { return -3; }
    let outlet = unsafe { &*out };
    let nch = outlet.outlet.info().channel_count() as usize;
    let slice = unsafe { std::slice::from_raw_parts(data as *const i8, nch) };
    outlet.outlet.push_sample_i16(&slice.iter().map(|&v| v as i16).collect::<Vec<_>>(), timestamp, pushthrough != 0);
    0
}
...
#[no_mangle]
pub extern "C" fn lsl_push_sample_strt(out: *mut LslOutlet, data: *const *const c_char, timestamp: c_double) -> i32 {
    lsl_push_sample_strtp(out, data, timestamp, 1)
}
#[no_mangle]
pub extern "C" fn lsl_push_sample_strtp(out: *mut LslOutlet, data: *const *const c_char, timestamp: c_double, pushthrough: i32) -> i32 {
    if out.is_null() || data.is_null() { return -3; }
    let outlet = unsafe { &*out };
    let nch = outlet.outlet.info().channel_count() as usize;
    let ptrs = unsafe { std::slice::from_raw_parts(data, nch) };
    let strings: Vec<String> = ptrs.iter().map(|&p| cstr_to_string(p)).collect();
    outlet.outlet.push_sample_str(&strings, timestamp, pushthrough != 0);
    0
}
...
#[no_mangle]
pub extern "C" fn lsl_push_sample_vt(out: *mut LslOutlet, data: *const c_void, timestamp: c_double) -> i32 {
    lsl_push_sample_vtp(out, data, timestamp, 1)
}
#[no_mangle]
pub extern "C" fn lsl_push_sample_vtp(out: *mut LslOutlet, data: *const c_void, timestamp: c_double, pushthrough: i32) -> i32 {
    if out.is_null() || data.is_null() { return -3; }
    let outlet = unsafe { &*out };
    let nbytes = outlet.outlet.info().sample_bytes();
    let slice = unsafe { std::slice::from_raw_parts(data as *const u8, nbytes) };
    outlet.outlet.push_sample_raw(slice, timestamp, pushthrough != 0);
    0
}

#[no_mangle]
pub extern "C" fn lsl_push_sample_buf(out: *mut LslOutlet, data: *const *const c_char, lengths: *const u32) -> i32 {
    lsl_push_sample_buftp(out, data, lengths, 0.0, 1)
}
#[no_mangle]
pub extern "C" fn lsl_push_sample_buft(out: *mut LslOutlet, data: *const *const c_char, lengths: *const u32, timestamp: c_double) -> i32 {
    lsl_push_sample_buftp(out, data, lengths, timestamp, 1)
}
#[no_mangle]
pub extern "C" fn lsl_push_sample_buftp(out: *mut LslOutlet, data: *const *const c_char, lengths: *const u32, timestamp: c_double, pushthrough: i32) -> i32 {
    if out.is_null() || data.is_null() || lengths.is_null() { return -3; }
    let outlet = unsafe { &*out };
    let nch = outlet.outlet.info().channel_count() as usize;
    let ptrs = unsafe { std::slice::from_raw_parts(data, nch) };
    let lens = unsafe { std::slice::from_raw_parts(lengths, nch) };
    let strings: Vec<String> = ptrs.iter().zip(lens).map(|(&p, &l)| {
...
macro_rules! impl_push_chunk {
    ($fname:ident, $fnamet:ident, $fnametp:ident, $fnametn:ident, $fnametnp:ident, $ty:ty, $method:ident) => {
        #[no_mangle]
        pub extern "C" fn $fname(out: *mut LslOutlet, data: *const $ty, data_elements: c_ulong) -> i32 {
            $fnametp(out, data, data_elements, 0.0, 1)
        }
        #[no_mangle]
        pub extern "C" fn $fnamet(out: *mut LslOutlet, data: *const $ty, data_elements: c_ulong, timestamp: c_double) -> i32 {
            $fnametp(out, data, data_elements, timestamp, 1)
        }
        #[no_mangle]
        pub extern "C" fn $fnametp(out: *mut LslOutlet, data: *const $ty, data_elements: c_ulong, timestamp: c_double, pushthrough: i32) -> i32 {
            if out.is_null() || data.is_null() { return -3; }
            let outlet = unsafe { &*out };
            let nch = outlet.outlet.info().channel_count() as usize;
            if nch == 0 { return -3; }
            ...
            let mut ts = if timestamp == 0.0 { local_clock() } else { timestamp };
            ...
            for i in 0..n_samples {
                ...
                outlet.outlet.$method(chunk, sample_ts, pushthrough != 0 && is_last);
            }
            0
        }
        #[no_mangle]
        pub extern "C" fn $fnametn(out: *mut LslOutlet, data: *const $ty, data_elements: c_ulong, timestamps: *const c_double) -> i32 {
            $fnametnp(out, data, data_elements, timestamps, 1)
        }
        #[no_mangle]
        pub extern "C" fn $fnametnp(out: *mut LslOutlet, data: *const $ty, data_elements: c_ulong, timestamps: *const c_double, pushthrough: i32) -> i32 {
            if out.is_null() || data.is_null() || timestamps.is_null() { return -3; }
            let outlet = unsafe { &*out };
            let nch = outlet.outlet.info().channel_count() as usize;
            if nch == 0 { return -3; }
            let slice = unsafe { std::slice::from_raw_parts(data, data_elements as usize) };
            ...
            for i in 0..n_samples {
                let chunk = &slice[i * nch..(i + 1) * nch];
                let is_last = i == n_samples - 1;
                outlet.outlet.$method(chunk, ts_slice[i], pushthrough != 0 && is_last);
            }
            0
        }
    }
...
impl_push_chunk!(lsl_push_chunk_f, lsl_push_chunk_ft, lsl_push_chunk_ftp, lsl_push_chunk_ftn, lsl_push_chunk_ftnp, c_float, push_sample_f);
impl_push_chunk!(lsl_push_chunk_d, lsl_push_chunk_dt, lsl_push_chunk_dtp, lsl_push_chunk_dtn, lsl_push_chunk_dtnp, c_double, push_sample_d);
impl_push_chunk!(lsl_push_chunk_l, lsl_push_chunk_lt, lsl_push_chunk_ltp, lsl_push_chunk_ltn, lsl_push_chunk_ltnp, i64, push_sample_i64);
impl_push_chunk!(lsl_push_chunk_i, lsl_push_chunk_it, lsl_push_chunk_itp, lsl_push_chunk_itn, lsl_push_chunk_itnp, i32, push_sample_i32);
impl_push_chunk!(lsl_push_chunk_s, lsl_push_chunk_st, lsl_push_chunk_stp, lsl_push_chunk_stn, lsl_push_chunk_stnp, i16, push_sample_i16);

// char chunks — treat each char as one i8 channel value
#[no_mangle] pub extern "C" fn lsl_push_chunk_c(out: *mut LslOutlet, data: *const c_char, data_elements: c_ulong) -> i32 { lsl_push_chunk_ctp(out, data, data_elements, 0.0, 1) }
#[no_mangle] pub extern "C" fn lsl_push_chunk_ct(out: *mut LslOutlet, data: *const c_char, data_elements: c_ulong, timestamp: c_double) -> i32 { lsl_push_chunk_ctp(out, data, data_elements, timestamp, 1) }
#[no_mangle]
pub extern "C" fn lsl_push_chunk_ctp(out: *mut LslOutlet, data: *const c_char, data_elements: c_ulong, timestamp: c_double, pushthrough: i32) -> i32 {
    if out.is_null() || data.is_null() { return -3; }
    let outlet = unsafe { &*out };
    let nch = outlet.outlet.info().channel_count() as usize;
    if nch == 0 { return -3; }
    ...
    let n_samples = slice.len() / nch;
    for i in 0..n_samples {
        let chunk: Vec<i16> = slice[i*nch..(i+1)*nch].iter().map(|&v| v as i16).collect();
        let ts = if i == 0 { timestamp } else { DEDUCED_TIMESTAMP };
        outlet.outlet.push_sample_i16(&chunk, ts, pushthrough != 0 && i == n_samples - 1);
    }
    0
}
#[no_mangle] pub extern "C" fn lsl_push_chunk_ctn(out: *mut LslOutlet, data: *const c_char, data_elements: c_ulong, timestamps: *const c_double) -> i32 { lsl_push_chunk_ctnp(out, data, data_elements, timestamps, 1) }
#[no_mangle]
pub extern "C" fn lsl_push_chunk_ctnp(out: *mut LslOutlet, data: *const c_char, data_elements: c_ulong, timestamps: *const c_double, pushthrough: i32) -> i32 {
    if out.is_null() || data.is_null() || timestamps.is_null() { return -3; }
    let outlet = unsafe { &*out };
    let nch = outlet.outlet.info().channel_count() as usize;
    if nch == 0 { return -3; }
    ...
    for i in 0..n_samples {
        let chunk: Vec<i16> = slice[i*nch..(i+1)*nch].iter().map(|&v| v as i16).collect();
        outlet.outlet.push_sample_i16(&chunk, ts_slice[i], pushthrough != 0 && i == n_samples - 1);
    }
    0
}

// string chunks
#[no_mangle] pub extern "C" fn lsl_push_chunk_str(out: *mut LslOutlet, data: *const *const c_char, data_elements: c_ulong) -> i32 { lsl_push_chunk_strtp(out, data, data_elements, 0.0, 1) }
#[no_mangle] pub extern "C" fn lsl_push_chunk_strt(out: *mut LslOutlet, data: *const *const c_char, data_elements: c_ulong, timestamp: c_double) -> i32 { lsl_push_chunk_strtp(out, data, data_elements, timestamp, 1) }
#[no_mangle]
pub extern "C" fn lsl_push_chunk_strtp(out: *mut LslOutlet, data: *const *const c_char, data_elements: c_ulong, timestamp: c_double, pushthrough: i32) -> i32 {
    if out.is_null() || data.is_null() { return -3; }
    let outlet = unsafe { &*out };
    let nch = outlet.outlet.info().channel_count() as usize;
    if nch == 0 { return -3; }
    ...
    for i in 0..n_samples {
        let strings: Vec<String> = ptrs[i*nch..(i+1)*nch].iter().map(|&p| cstr_to_string(p)).collect();
        let ts = if i == 0 { timestamp } else { DEDUCED_TIMESTAMP };
        outlet.outlet.push_sample_str(&strings, ts, pushthrough != 0 && i == n_samples - 1);
    }
    0
}
#[no_mangle] pub extern "C" fn lsl_push_chunk_strtn(out: *mut LslOutlet, data: *const *const c_char, data_elements: c_ulong, timestamps: *const c_double) -> i32 { lsl_push_chunk_strtnp(out, data, data_elements, timestamps, 1) }
#[no_mangle]
pub extern "C" fn lsl_push_chunk_strtnp(out: *mut LslOutlet, data: *const *const c_char, data_elements: c_ulong, timestamps: *const c_double, pushthrough: i32) -> i32 {
    if out.is_null() || data.is_null() || timestamps.is_null() { return -3; }
    let outlet = unsafe { &*out };
    let nch = outlet.outlet.info().channel_count() as usize;
    if nch == 0 { return -3; }
    ...
    for i in 0..n_samples {
        let strings: Vec<String> = ptrs[i*nch..(i+1)*nch].iter().map(|&p| cstr_to_string(p)).collect();
        outlet.outlet.push_sample_str(&strings, ts_slice[i], pushthrough != 0 && i == n_samples - 1);
    }
    0
}

// buf chunks
#[no_mangle] pub extern "C" fn lsl_push_chunk_buf(out: *mut LslOutlet, data: *const *const c_char, lengths: *const u32, data_elements: c_ulong) -> i32 { lsl_push_chunk_buftp(out, data, lengths, data_elements, 0.0, 1) }
#[no_mangle] pub extern "C" fn lsl_push_chunk_buft(out: *mut LslOutlet, data: *const *const c_char, lengths: *const u32, data_elements: c_ulong, timestamp: c_double) -> i32 { lsl_push_chunk_buftp(out, data, lengths, data_elements, timestamp, 1) }
#[no_mangle]
pub extern "C" fn lsl_push_chunk_buftp(out: *mut LslOutlet, data: *const *const c_char, lengths: *const u32, data_elements: c_ulong, timestamp: c_double, pushthrough: i32) -> i32 {
    if out.is_null() || data.is_null() || lengths.is_null() { return -3; }
    let outlet = unsafe { &*out };
    let nch = outlet.outlet.info().channel_count() as usize;
    if nch == 0 { return -3; }
    ...
    let n_samples = ptrs.len() / nch;
    for i in 0..n_samples {
        let strings: Vec<String> = (0..nch).map(|j| {
            let idx = i * nch + j;
            let bytes = unsafe { std::slice::from_raw_parts(ptrs[idx] as *const u8, lens[idx] as usize) };
            String::from_utf8_lossy(bytes).into_owned()
        }).collect();
        let ts = if i == 0 { timestamp } else { DEDUCED_TIMESTAMP };
        outlet.outlet.push_sample_str(&strings, ts, pushthrough != 0 && i == n_samples - 1);
...
#[no_mangle] pub extern "C" fn lsl_push_chunk_buftn(out: *mut LslOutlet, data: *const *const c_char, lengths: *const u32, data_elements: c_ulong, timestamps: *const c_double) -> i32 { lsl_push_chunk_buftnp(out, data, lengths, data_elements, timestamps, 1) }
#[no_mangle]
pub extern "C" fn lsl_push_chunk_buftnp(out: *mut LslOutlet, data: *const *const c_char, lengths: *const u32, data_elements: c_ulong, timestamps: *const c_double, pushthrough: i32) -> i32 {
    if out.is_null() || data.is_null() || lengths.is_null() || timestamps.is_null() { return -3; }
    let outlet = unsafe { &*out };
    let nch = outlet.outlet.info().channel_count() as usize;
    if nch == 0 { return -3; }
    let ptrs = unsafe { std::slice::from_raw_parts(data, data_elements as usize) };
...
#[no_mangle]
pub extern "C" fn lsl_create_inlet(info: *mut LslStreamInfo, max_buflen: i32, max_chunklen: i32, recover: i32) -> *mut LslInlet {
    null_check!(info);
    let info = unsafe { &*info };
...
#[no_mangle]
pub extern "C" fn lsl_create_inlet_ex(info: *mut LslStreamInfo, max_buflen: i32, max_chunklen: i32, recover: i32, _flags: i32) -> *mut LslInlet {
    lsl_create_inlet(info, max_buflen, max_chunklen, recover)
}

#[no_mangle]
pub extern "C" fn lsl_destroy_inlet(inlet: *mut LslInlet) {
    if !inlet.is_null() { unsafe { let _ = Box::from_raw(inlet); } }
}

#[no_mangle]
pub extern "C" fn lsl_get_fullinfo(inlet: *mut LslInlet, timeout: c_double, ec: *mut i32) -> *mut LslStreamInfo {
    if !ec.is_null() { unsafe { *ec = 0; } }
    null_check!(inlet);
...
pub extern "C" fn lsl_open_stream(inlet: *mut LslInlet, timeout: c_double, ec: *mut i32) {
    if !ec.is_null() { unsafe { *ec = 0; } }
    if inlet.is_null() { return; }
    let result = unsafe { &*inlet }.inlet.open_stream(timeout);
    if let Err(_) = result {
        if !ec.is_null() { unsafe { *ec = ErrorCode::TimeoutError as i32; } }
    }
}
...
#[no_mangle]
pub extern "C" fn lsl_time_correction(inlet: *mut LslInlet, timeout: c_double, ec: *mut i32) -> c_double {
    if !ec.is_null() { unsafe { *ec = 0; } }
    if inlet.is_null() { return 0.0; }
    unsafe { &*inlet }.inlet.time_correction(timeout)
}

#[no_mangle]
pub extern "C" fn lsl_time_correction_ex(inlet: *mut LslInlet, remote_time: *mut c_double, uncertainty: *mut c_double, timeout: c_double, ec: *mut i32) -> c_double {
    if !ec.is_null() { unsafe { *ec = 0; } }
    if !remote_time.is_null() { unsafe { *remote_time = 0.0; } }
    if !uncertainty.is_null() { unsafe { *uncertainty = 0.0; } }
    if inlet.is_null() { return 0.0; }
    unsafe { &*inlet }.inlet.time_correction(timeout)
}
...
macro_rules! impl_pull_sample {
    ($fname:ident, $ty:ty, $method:ident) => {
        #[no_mangle]
        pub extern "C" fn $fname(inlet: *mut LslInlet, buffer: *mut $ty, buffer_elements: i32, timeout: c_double, ec: *mut i32) -> c_double {
            if !ec.is_null() { unsafe { *ec = 0; } }
            if inlet.is_null() || buffer.is_null() { return 0.0; }
            ...
            match inlet.inlet.$method(buf, timeout) {
                Ok(ts) => ts,
                Err(_) => {
                    if !ec.is_null() { unsafe { *ec = ErrorCode::InternalError as i32; } }
                    0.0
                }
            }
        }
...
#[no_mangle]
pub extern "C" fn lsl_pull_sample_c(inlet: *mut LslInlet, buffer: *mut c_char, buffer_elements: i32, timeout: c_double, ec: *mut i32) -> c_double {
    // Pull as i8
    if !ec.is_null() { unsafe { *ec = 0; } }
    if inlet.is_null() || buffer.is_null() { return 0.0; }
    ...
    match inlet_ref.inlet.pull_sample_i16(&mut tmp, timeout) {
        Ok(ts) => {
            let dst = unsafe { std::slice::from_raw_parts_mut(buffer as *mut u8, buffer_elements as usize) };
            for (d, s) in dst.iter_mut().zip(tmp.iter()) { *d = *s as u8; }
            ts
        }
        Err(_) => 0.0,
    }
...
#[no_mangle]
pub extern "C" fn lsl_pull_sample_str(inlet: *mut LslInlet, buffer: *mut *mut c_char, buffer_elements: i32, timeout: c_double, ec: *mut i32) -> c_double {
    if !ec.is_null() { unsafe { *ec = 0; } }
    if inlet.is_null() || buffer.is_null() { return 0.0; }
    let inlet_ref = unsafe { &*inlet };
    match inlet_ref.inlet.pull_sample_str(timeout) {
        Ok((strings, ts)) => {
            ...
            for i in 0..n {
                let cstr = CString::new(strings[i].as_str()).unwrap_or_else(|_| CString::new("").unwrap());
                unsafe { *buffer.add(i) = cstr.into_raw(); }
            }
            ts
        }
        Err(_) => 0.0,
...
#[no_mangle]
pub extern "C" fn lsl_pull_sample_buf(inlet: *mut LslInlet, buffer: *mut *mut c_char, buffer_lengths: *mut u32, buffer_elements: i32, timeout: c_double, ec: *mut i32) -> c_double {
    if !ec.is_null() { unsafe { *ec = 0; } }
    if inlet.is_null() || buffer.is_null() { return 0.0; }
    let inlet_ref = unsafe { &*inlet };
    match inlet_ref.inlet.pull_sample_str(timeout) {
...
#[no_mangle]
pub extern "C" fn lsl_pull_sample_v(inlet: *mut LslInlet, buffer: *mut c_void, buffer_bytes: i32, timeout: c_double, ec: *mut i32) -> c_double {
    if !ec.is_null() { unsafe { *ec = 0; } }
    if inlet.is_null() || buffer.is_null() { return 0.0; }
    let inlet_ref = unsafe { &*inlet };
...
macro_rules! impl_pull_chunk {
    ($fname:ident, $ty:ty, $method:ident) => {
        ...
        pub extern "C" fn $fname(
            ...
            if !ec.is_null() { unsafe { *ec = 0; } }
            if inlet.is_null() || data_buffer.is_null() { return 0; }
            let inlet_ref = unsafe { &*inlet };
            let nch = inlet_ref.inlet.get_fullinfo(0.0).channel_count() as usize;
            if nch == 0 { return 0; }
            let max_samples = data_buffer_elements as usize / nch;
            let end_time = if timeout > 0.0 { local_clock() + timeout } else { 0.0 };
            let mut samples_written = 0usize;

            for i in 0..max_samples {
                let remaining = if timeout > 0.0 { (end_time - local_clock()).max(0.0) } else { 0.0 };
                ...
                match inlet_ref.inlet.$method(buf, remaining) {
                    Ok(ts) if ts > 0.0 => {
                        if !timestamp_buffer.is_null() {
                            unsafe { *timestamp_buffer.add(i) = ts; }
                        }
                        samples_written += 1;
                    }
                    _ => break,
...
pub extern "C" fn lsl_pull_chunk_c(
    inlet: *mut LslInlet, data: *mut c_char, ts: *mut c_double,
    data_buffer_elements: c_ulong, timestamp_buffer_elements: c_ulong,
    timeout: c_double, ec: *mut i32,
) -> c_ulong {
    if !ec.is_null() { unsafe { *ec = 0; } }
    if inlet.is_null() || data.is_null() { return 0; }
    let inlet_ref = unsafe { &*inlet };
    let nch = inlet_ref.inlet.get_fullinfo(0.0).channel_count() as usize;
    if nch == 0 { return 0; }
    let max_samples = data_buffer_elements as usize / nch;
    ...
    for i in 0..max_samples {
        ...
        match inlet_ref.inlet.pull_sample_i16(&mut buf, remaining) {
            Ok(t) if t > 0.0 => {
                for j in 0..nch {
                    unsafe { *data.add(i * nch + j) = buf[j] as c_char; }
                }
                if !ts.is_null() { unsafe { *ts.add(i) = t; } }
                samples_written += 1;
            }
            _ => break,
        }
...
pub extern "C" fn lsl_pull_chunk_str(
    inlet: *mut LslInlet, data: *mut *mut c_char, ts: *mut c_double,
    data_buffer_elements: c_ulong, timestamp_buffer_elements: c_ulong,
    timeout: c_double, ec: *mut i32,
) -> c_ulong {
    if !ec.is_null() { unsafe { *ec = 0; } }
        ...
        match inlet_ref.inlet.pull_sample_str(remaining) {
            Ok((strings, t)) if t > 0.0 => {
                for (j, s) in strings.iter().enumerate().take(nch) {
                    unsafe { *data.add(i * nch + j) = string_to_cstr(s); }
                }
                if !ts.is_null() { unsafe { *ts.add(i) = t; } }
                samples_written += 1;
            }
...
pub extern "C" fn lsl_pull_chunk_buf(
    inlet: *mut LslInlet, data: *mut *mut c_char, lengths: *mut u32,
    ts: *mut c_double,
    data_buffer_elements: c_ulong, timestamp_buffer_elements: c_ulong,
    timeout: c_double, ec: *mut i32,
) -> c_ulong {
                    ...
                    if !ptr.is_null() {
                        unsafe {
                            ...
                            *data.add(i * nch + j) = ptr as *mut c_char;
                            if !lengths.is_null() { *lengths.add(i * nch + j) = bytes.len() as u32; }
                        }
                    }
                }
                if !ts.is_null() { unsafe { *ts.add(i) = t; } }
...
#[no_mangle]
pub extern "C" fn lsl_resolve_all(buffer: *mut *mut LslStreamInfo, buffer_elements: u32, wait_time: c_double) -> i32 {
    ...
    for (i, info) in results.into_iter().take(n).enumerate() {
        unsafe { *buffer.add(i) = Box::into_raw(Box::new(LslStreamInfo { info })); }
    }
    n as i32
}

#[no_mangle]
pub extern "C" fn lsl_resolve_byprop(buffer: *mut *mut LslStreamInfo, buffer_elements: u32, prop: *const c_char, value: *const c_char, minimum: i32, timeout: c_double) -> i32 {
    if buffer.is_null() { return 0; }
...
#[no_mangle]
pub extern "C" fn lsl_resolve_bypred(buffer: *mut *mut LslStreamInfo, buffer_elements: u32, pred: *const c_char, minimum: i32, timeout: c_double) -> i32 {
    if buffer.is_null() { return 0; }
...
#[no_mangle]
pub extern "C" fn lsl_create_continuous_resolver(forget_after: c_double) -> *mut LslContinuousResolver {
    let resolver = ContinuousResolver::new("", forget_after);
    Box::into_raw(Box::new(LslContinuousResolver { resolver }))
}

#[no_mangle]
pub extern "C" fn lsl_create_continuous_resolver_byprop(prop: *const c_char, value: *const c_char, forget_after: c_double) -> *mut LslContinuousResolver {
    let prop = cstr_to_string(prop);
    let value = cstr_to_string(value);
    let query = if value.is_empty() { String::new() } else { format!("{}='{}'", prop, value) };
    let resolver = ContinuousResolver::new(&query, forget_after);
    Box::into_raw(Box::new(LslContinuousResolver { resolver }))
}

#[no_mangle]
pub extern "C" fn lsl_create_continuous_resolver_bypred(pred: *const c_char, forget_after: c_double) -> *mut LslContinuousResolver {
    let pred = cstr_to_string(pred);
...
#[no_mangle]
pub extern "C" fn lsl_resolver_results(res: *mut LslContinuousResolver, buffer: *mut *mut LslStreamInfo, buffer_elements: u32) -> i32 {
    if res.is_null() || buffer.is_null() { return 0; }
...
pub extern "C" fn lsl_destroy_continuous_resolver(res: *mut LslContinuousResolver) {
    if !res.is_null() { unsafe { let _ = Box::from_raw(res); } }
}
...
#[no_mangle]
pub extern "C" fn lsl_append_child_value(e: *mut LslXmlPtr, name: *const c_char, value: *const c_char) -> *mut LslXmlPtr {
    null_check!(e);
    let name = cstr_to_string(name);
    let value = cstr_to_string(value);
...
#[no_mangle]
pub extern "C" fn lsl_prepend_child_value(e: *mut LslXmlPtr, name: *const c_char, value: *const c_char) -> *mut LslXmlPtr {
    null_check!(e);
    let name = cstr_to_string(name);
    let value = cstr_to_string(value);
...
#[no_mangle]
pub extern "C" fn lsl_set_child_value(e: *mut LslXmlPtr, name: *const c_char, value: *const c_char) -> i32 {
    if e.is_null() { return 0; }
    let name = cstr_to_string(name);
    let value = cstr_to_string(value);
...
pub extern "C" fn lsl_append_copy(e: *mut LslXmlPtr, e2: *mut LslXmlPtr) -> *mut LslXmlPtr {
    if e.is_null() || e2.is_null() { return ptr::null_mut(); }
...
pub extern "C" fn lsl_remove_child_n(e: *mut LslXmlPtr, name: *const c_char) {
    if e.is_null() { return; }
    unsafe { &*e }.node.remove_child_named(&cstr_to_string(name));
}

#[no_mangle]
pub extern "C" fn lsl_remove_child(e: *mut LslXmlPtr, e2: *mut LslXmlPtr) {
    if e.is_null() || e2.is_null() { return; }
