//! `pylsl` — Python bindings for `rlsl`.
//!
...
//! ```
//!
//! Build with: `maturin develop -m crates/rlsl-py/Cargo.toml`

use rlsl::clock;
use rlsl::inlet::StreamInlet as RsInlet;
use rlsl::outlet::StreamOutlet as RsOutlet;
use rlsl::resolver;
use rlsl::stream_info::StreamInfo as RsStreamInfo;
use rlsl::types::*;
use ndarray::Array2;
